...
Rails.application.config.assets.precompile += %w( common/* devise/* ie/* products.css abouts.css services.css news.css contacts.css steps.css direct_sellings.css )
